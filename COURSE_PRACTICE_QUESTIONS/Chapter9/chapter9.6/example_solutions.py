...
df1 = pd.read_csv('data/gene_expression.csv')
print(df1.head())

#* 2. Reading TSV into DataFrame
df2 = pd.read_csv('data/protein_data.tsv', sep='\t')
print(df2.head())

#* 3. Reading JSON into DataFrame
df3 = pd.read_json('data/experiment.json')
print(df3.head())
...
df4.to_csv('output/output.csv', index=False)
df4.to_json('output/output.json')
